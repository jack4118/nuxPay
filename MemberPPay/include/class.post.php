...
class post{
  ...
  public function curlUtm($command, $params = array(), $site="Admin", $language="english", $source="PPay", $sourceVersion="", $userAgent="")
  {
...
//        curl_setopt($ch, CURLOPT_TIMEOUT, 60); //timeout in seconds
    ...
    if($msgReturn['code'] == 3) {
      session_destroy();
            ...
            function curl_post($command, $params = array(), $site="Member", $language="english", $source="PPay", $sourceVersion="", $userAgent="") {
          //   include(__DIR__.'/config.php');
          //   include(__DIR__.'/class.msgpack.php');
    ...
    // if(!in_array($command, $filteredCommand)) $params["business_email"] = $_SESSION["business_email"];
            ...
            function curl_post_multipart($command, $params = array(), $source = "PPay") {
              include(dirname(__FILE__)."/../include/config.php");
    ...
    // curl_setopt($ch, CURLOPT_HTTPHEADER, array('X-Xun-Token: '.$_SESSION["access_token"], 'Content-Type: multipart/form-data; boundary=' . $boundary));
            ...
            function curl_post_pass($command, $params = array(), $source = "PPay") {
              include(dirname(__FILE__)."/../include/config.php");
    ...
    // if(!in_array($command, $filteredCommand)) $params["business_email"] = $_SESSION["business_email"];
            ...
            function curl_get($command, $params = array(), $source = "PPay") {
              include(dirname(__FILE__)."/../include/config.php");
