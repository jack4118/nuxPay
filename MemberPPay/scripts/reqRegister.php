...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    switch($command) {
        ...
        $result = $post->curl_post("/web/pay/register", $params,"Member","english","PPay");
        ...
        $result = $post->curl_post("/web/pay/register/otp/get", $params,"Member","english","PPAY");
        ...
        $result = $post->curl_post("/xun/business/mobile/verifycode/verify", $params,"Member","english","PPay");
        ...
        $result = $post->curl_post("/xun/business/create", $params,"Member","english","PPay");
