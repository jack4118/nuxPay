							...
							<div class="col-12 landingPageMargin" style="padding-left: 28px;">
								<div class="row">
									<div class="col-12 landingTitle">
										The Ultimate Payment Solution Platform
									</div>
									<div class="col-12" style="margin-top: 30px;">
										...
										<span class="landingDesc item2">We Accept All Business Types & Currencies</span>
											...
											<div class="col-xl-6 col-lg-7 col-md-10 col-12" style="margin-top: 20px;">
												<div class="row">
													<div class="landingPart01">
														<select id="countryCode" class="form-control pPaySection01Dropdown">
