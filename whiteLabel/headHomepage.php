...
<head>
	...
	<?php }else{ ?>
		<meta property="og:url" content="<?php echo $currentURL; ?>">
		<meta property="og:image" content="<?php echo 'https://ppay99.com/images/logo-270.png'; ?>">
		<meta property="og:image:secure_url" content="<?php echo 'https://ppay99.com/images/logo-270.png'; ?>">
		<meta property="og:title" content="<?php echo $sys['title']; ?>">
		<meta property="og:description" content="<?php echo $sys['metaDesc']; ?>">
		<meta property="og:type" content="website">
		<meta property="og:site_name" content="PPay99">
