				...
				<div class="row">
					<div class="loginContainer">
						<div class="row">
							...
							<div class="col-12 pPayDesc text-center pPayLoginFormMargin1" style="color: #000">
								<span>Dear </span>
								<span id="userRegisterName"></span>
							</div>
							<div class="col-12 pPayNoAccount text-center mt-4" style="color: #000">
								<span>an OTP had been sent to your phone number </span>
								<span id="userMobileNumber"></span>
							</div>

							<div class="col-12 text-center pPayLoginFormMargin2" style="">
								<div class="row">
