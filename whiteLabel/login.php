        ...
        <div class="modal-dialog modal-sm" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body text-center py-0">
                    ...
                    <div id="canvasAlertMessage" class="f-14">Please confirm your phone number <b id="confirmEmail"></b>.</div>
                </div>
...
<script>
    ...
    $(document).ready(function () {
       ...
       if (type == "") {
            ...
            if (windowHeight <= 600) {
                 $('.pPayLoginHeight2').addClass('lowerHeight');
            }
        ...
        $('#partLoginOpen').click(function (){
            ...
            var windowHeight = window.innerHeight;
            if (windowHeight <= 500) {
                 $('.pPayLoginHeight').addClass('lowerHeight');
            }
