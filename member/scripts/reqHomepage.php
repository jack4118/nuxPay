    ...
    if($_POST['type'] == 'logout'){
        ...
        switch($command) {
            ...
            case "requestfundcheckuserexist":
                ...
                $params = array(
                    "payee_mobile" => $_POST['payee_mobile'],
                    "payee_email" => $_POST['payee_email'],

                );
                $result = $post->curl_post("/request/fund/check/user/exist", $params);

                echo $result;

            break;

            case "getCryptoPricing":
                $params = array();

                $result = $post->curl_post("/web/pay/get/crypto/pricing", $params);
