							...
							<div class="row pb-4">
								<div class="col-md-6 homepageTitle">
									<h1>
										...
										to accept crypto payments<br>
									</h1>
									<p class="d-flex mt-4 homepageDesc">
										<span class="tickIco">
									...
									<!-- </div> -->
									<div class="row">
										<div class="whiteLabelSection01Part01">
											<select id="countryCode" class="form-control nuxPaySection01Dropdown">
												<?php include 'phoneList.php'; ?>
											</select>
										</div>
										<div class="whiteLabelSection01Part02">
											<input id="phoneNumber" type="text" class="form-control nuxPaySection01Input" placeholder="Mobile Number">
										</div>
										<div class="whiteLabelSection01Part03">
								...
								<div class="col-md-6 pr-0">
									<img src="images/whitelabel/gem/homepage01.png" alt="" width="100%">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-12">
							<div class="row align-items-center">
								<div class="col-md-5 pl-0 position-relative">
									<img src="images/whitelabel/gem/homepage02.png" alt="" width="90%">
									<div class="homepageComment normalText">
										<p class="text-grey pb-3 border-bottom">
											...
											GemDirectPay is an excellent, well-managed payment gateway. The gateway provide the technology and solutions to accept payments from around the world.
										</p>
										<b class="d-block">
											Mark Cuban
										</b>
								...
								<div class="col-md-6 offset-md-1 py-4 py-md-0">
									<div>
										<h2 class="bigText mb-5">Why <span class="text-blue">GemDirectPay?</span></h2>
										...
										<div class="d-flex align-items-center mb-4">
											...
											<div class="col normalText">
												<b class="d-inline-flex align-items-center">World Wide <img class="ml-3" src="images/whitelabel/gem/ico_world.png" width="30px"></b>
										...
										<div class="d-flex align-items-center mb-4">
											...
											<div class="col normalText">
												<b class="d-inline-flex align-items-center">Easy Implemetation <img class="ml-3" src="images/whitelabel/gem/ico_implement.png" width="30px"></b>
												<span class="d-block mt-1 text-grey">
										...
										<div class="d-flex align-items-center mb-4">
											...
											<div class="col normalText">
												<b class="d-inline-flex align-items-center">Access Anytime, Anywhere <img class="ml-3" src="images/whitelabel/gem/ico_anytime.png" width="30px"></b>
												<span class="d-block mt-1 text-grey">
													Mobile Accessible & get instant notification with GemDirectPay no matter where you go and what time it is
												</span>
											</div>
										</div>
										...
										<div class="d-flex align-items-center mb-4">
											...
											<div class="col normalText">
												<b class="d-inline-flex align-items-center">FinTech Expert <img class="ml-3" src="images/whitelabel/gem/ico_fintech.png" width="30px"></b>
												<span class="d-block mt-1 text-grey">
													With more than 10 years’ experience in FinTech, GemDirectPay Payment Solution is suitable for all business type.
												</span>
											</div>
										</div>
										...
										<div class="d-flex align-items-center mb-4">
											...
											<div class="col normalText">
												<b class="d-inline-flex align-items-center">Accept All Business Type <img class="ml-3" src="images/whitelabel/gem/ico_business.png" width="30px"></b>
												<span class="d-block mt-1 text-grey">
										...
										<div class="d-flex align-items-center mb-4">
											...
											<div class="col normalText">
												<b class="d-inline-flex align-items-center">One Reconciliation <img class="ml-3" src="images/whitelabel/gem/ico_statistic.png" width="30px"></b>
												<span class="d-block mt-1 text-grey">
				...
				<section class="homepageSec3 position-relative">
					<div class="kt-container w-100 px-0 pt-5">
						<div class="col-12 text-center mb-4">
							<h2 class="bigText">About <span class="text-blue">GemDirectPay</span></h2>
						</div>
						<div class="col-12">
							<div class="row justify-content-center">
								<div class="homepageAbtBlock normalText">
									<img src="images/whitelabel/gem/ico_total.png" width="40px">
									<div>Total</div>
									<div class="bigTxt">20,000,000+</div>
									<div class="mt-2">Transactions</div>
								</div>
								<div class="homepageAbtBlock normalText">
									<img src="images/whitelabel/gem/ico_process.png" width="40px">
									<div>We’ve processed over</div>
									<div class="bigTxt">$ 50 million</div>
									<div class="mt-2">Yearly</div>
								</div>
								<div class="homepageAbtBlock normalText">
									<img src="images/whitelabel/gem/ico_available.png" width="40px">
						...
						<div class="col-12">
							<div class="row align-items-center">
									...
									<div>
										...
										<div class="d-flex align-items-center mb-4">
											...
											<div class="col text-grey normalText">
												GemDirectPay is expert in FinTech by providing professional service to help company to reach their potential markets around the world by using the perfect payment solution for their business.
											</div>
										</div>
										...
										<div class="d-flex align-items-center mb-4">
											...
											<div class="col text-grey normalText">
												Excellent communication between GemDirectPay and clients are the key to our success. If you’re interested in high level of reliable payment solution, you have come to the right place. GemDirectPay is the right payment solution for you.
											</div>
										</div>
								...
								<div class="col-md-5 offset-md-1">
									<img src="images/whitelabel/gem/homepage03.jpg" alt="" width="100%">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-12">
							<div class="row align-items-center">
								<div class="col-md-7 pl-0 position-relative">
									<img src="images/whitelabel/gem/homepage04.png" alt="" width="100%">
								</div>
								<div class="col-md-5">
									<div>
										<h2 class="bigText">GemDirectPay Merchants Solution</h2>

										<p class="py-1 text-grey normalText">Offer your customers and start using GemDirectPay as a payment option! It helps your business to stand out against competitors with our service.</p>
		...
		$('#sendContactUs').click(function(){
			...
			if( $('input#name').val() == ''){
				...
				formData        = {
					...
					subject : 'GemDirectPay Homepage Contact Us',
					message : message,
					keyword : keyword
				};
