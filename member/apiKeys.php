						...
						<div class="col-12 mt-5 mt-md-5">
							<div class="row">
								<div class="col-12 bigText">
									<?php echo $translations["M02101"][$language]; /* White List API Key */?>
									<?php echo"<br>" ?>
									<?php echo $translations["M02024"][$language]; /* API Keys */?>
								</div>
								<div class="col-12 smallTxt">
            ...
            <div class="modal-footer bg-w">
                <div class="col-12 text-center">
                    <a href="javascript:void(0)" id="confirmBtn" class="btn primaryBtn enableStep1" style="">
						<?php echo $translations["M01788"][$language]; /* Confirm */?>
					</a>
	...
	$(document).ready(function() {		
		...
		$('#generateBtn').click(function(){    
		    ...
		    function addNewApi(data,message){
		        showMessage(message, 'success', '<?php echo $translations["M01195"][$language]; /* Success */ ?>', "check-circle-o", 'apiKeys.php');
		    };
		 });
		});
	    ...
	    function loadApiKeyListing(data, message) {
	        ...
	        $('#'+tableId).find('tbody tr').each(function(){
	       	...
	       	$('.deleteApiId').click(function()
	       	{
	       		...
	       		var canvasBtnArray = Array('<?php echo $translations["M00364"][$language]; /* Delete */ ?>');
