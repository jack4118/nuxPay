...
(function () {
  ...
  for (var i = 0, n = langs.length; i < n; ++i) (function (lang) {
    ...
    script.src = LOADER_BASE_URL
      + 'js/' + encodeURIComponent(langs[i]) + '.js';
  ...
  for (var i = 0, n = skins.length; i < n; ++i) {
    skinUrls.push(LOADER_BASE_URL
        + 'css/' + encodeURIComponent(skins[i]) + '.css');
  }
  // skinUrls.push(LOADER_BASE_URL + 'css/prettify.css'); // this pretiffy.css file is not existed
