    ...
    <div class="block-option pull-right headerLogin" style="padding-right: 30px; padding-top: 3px;position: relative;top: 5px;">
        <ul class="nav navbar-nav-custom">
            <li id="loginNav" class="headerlist">
                <a href="login.php" class="" style="vertical-align: middle; font-weight: 600; color: #0D122B;"><?php echo $translations["M00012"][$language]; ?><!-- Log In --></a><span><i class="fa fa-external-link f-20" style="margin-left: 15px; vertical-align: middle; position: relative; top: 1px;"></i></span>
            </li>
            </li>
            <li id="signUpNav"  class="headerlist">
                <a href="newsignup.php" class="" style="vertical-align: middle; font-weight: 600; color: #0D122B;"><?php echo $translations["M00013"][$language]; ?><!-- Sign Up --></a><span><i class="fa fa-external-link f-20" style="margin-left: 15px; vertical-align: middle; position: relative; top: 1px;"></i></span>
            </li>
