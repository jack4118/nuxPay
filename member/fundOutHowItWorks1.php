        ...
        <div class="m-grid m-grid--hor m-grid--root m-page">
            ...
            <div class="m-grid__item m-grid__item--fluid m-wrapper">
                ...
                <div class="m-content marginTopHeader">
                    ...
                    <div class="col-md-12" style="text-align:center;" id="nuxpay">
                        
                            <img src="<?php echo $sys['source'] == 'FTAG' ?  'images/whitelabel/ftag/Fund-Out-1.png' :  'images/fundOut/how-it-work-1.png'?>" style="width:100%; max-width: 371px;">
                    ...
                    <div class="col-md-12" style="text-align:center; padding-top: 100px;">
                        <p>You deposit fund into an unique fund-out wallet address <br> which is generated by <?php echo $sys['companyName']?>.</p>
                    </div>
                    <div class="col-md-12" style="text-align:center">
                        <a href="fundOutHowItWorks2.php">Next ></a>
                    </div>
                </div>
            </div>
