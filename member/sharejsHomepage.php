...
<script src="<?php echo $sys['domain']?>/js/jquery.min.js" type="text/javascript"></script>
<script defer src="<?php echo $sys['domain']?>/js/vendors.js" type="text/javascript"></script>
<script defer src="<?php echo $sys['domain']?>/js/newVendors.js" type="text/javascript"></script>

<script defer src="<?php echo $sys['domain']?>/js/main.js?vs=<?php echo $version; ?>" type="text/javascript"></script>
...
<script defer src="<?php echo $sys['domain']?>/js/logout.js"></script>
<script defer src="<?php echo $sys['domain']?>/js/search.js"></script>
<?php echo '<script defer src="'.$sys['domain'].'/js/table.js?ts='.$sys['version'].'"></script>'; ?>

<script defer src="<?php echo $sys['domain']?>/js/livechat/perfectScrollbar.js"></script>

<?php if ($sys['isWhitelabel'] != 1) {
echo '<script defer src="https://www.thenux.com/js/liveChatWidget.js?id=11607" id="liveChatWidgetScript"></script>';
}?>
<script src="<?php echo $sys['domain']?>/js/aos.js"></script>
<script defer src="<?php echo $sys['domain']?>/js/waves.js"></script>
<script defer src="<?php echo $sys['domain']?>/js/moment.js"></script>
<script defer src="<?php echo $sys['domain']?>/js/moment-timezone.js"></script>
<script defer src="<?php echo $sys['domain']?>/js/moment-timezone-with-data.js"></script>
<script defer src="<?php echo $sys['domain']?>/js/bootstrap-switch.js" type="text/javascript"></script>
<script defer src="<?php echo $sys['domain']?>/js/jquery.simplePagination.js" type="text/javascript"></script>

<script defer src="<?php echo $sys['domain']?>/js/moment/moment.js" type="text/javascript"></script>
<script defer src="<?php echo $sys['domain']?>/js/moment/moment-with-locales.js" type="text/javascript"></script>
<script defer src="<?php echo $sys['domain']?>/js/dropify.min.js"></script>
...
<script defer>
    ...
    var customDomain = '<?php echo $customDomain; ?>';
...
$('#newBusinessBtn').click(function(){
    ...
    $(document).ready(function () {
        ...
        function handleNavBar(mode) {
            ...
            if(customDomain=="nuxpay.co") {
                largeLogoTop = "<?php echo $sys['loginLogoNuxpayCo']; ?>";
                smallLogoTop = "<?php echo $sys['loginLogoNuxpayCo']; ?>";
                largeLogoScrolled = "<?php echo $sys['homepageHeaderLogoNuxpayCo']; ?>";
                smallLogoScrolled = "<?php echo $sys['homepageHeaderLogoMobileNuxpayCo']; ?>";
            } else if(customDomain=="nuxpay.net") {
                largeLogoTop = "<?php echo $sys['loginLogoNuxpayNet']; ?>";
                smallLogoTop = "<?php echo $sys['loginLogoNuxpayNet']; ?>";
                largeLogoScrolled = "<?php echo $sys['homepageHeaderLogoNuxpayNet']; ?>";
                smallLogoScrolled = "<?php echo $sys['homepageHeaderLogoMobileNuxpayNet']; ?>";
            } else if(customDomain=="nuxpay.io") {
                largeLogoTop = "<?php echo $sys['loginLogoNuxpayIo']; ?>";
                smallLogoTop = "<?php echo $sys['loginLogoNuxpayIo']; ?>";
                largeLogoScrolled = "<?php echo $sys['homepageHeaderLogoNuxpayIo']; ?>";
                smallLogoScrolled = "<?php echo $sys['homepageHeaderLogoMobileNuxpayIo']; ?>";
            } else {
                largeLogoTop = "<?php echo $sys['loginLogo']; ?>";
                smallLogoTop = "<?php echo $sys['loginLogo']; ?>";
                largeLogoScrolled = "<?php echo $sys['homepageHeaderLogo']; ?>";
                smallLogoScrolled = "<?php echo $sys['homepageHeaderLogoMobile']; ?>";
            }

            if(thisPage == "" || thisPage == "index.php") {

                if(mode=="top") {
                    $('#navLargeLogo').attr("src", largeLogoTop);
                    $('#navSmallLogo').attr("src", smallLogoTop);
                    $('#homepageContactUs').css('color', 'black');
                    $('#homepageEarnAsReseller').css('color', 'black');
                    $('#homepageApiDoc').css('color', 'black');
                    $('#homepageLogin').css('color', 'black');
                    $('#homepageSignup').css('color', 'black');
					$('#languageSpan').css('color', 'black');
;                    
                    $('#navBarHamburger').removeClass();

                } else {
                    $('#navLargeLogo').attr("src", largeLogoScrolled);
                    $('#navSmallLogo').attr("src", smallLogoScrolled);
                    $('#homepageContactUs').css('color', 'white');
                    $('#homepageEarnAsReseller').css('color', 'white');
                    $('#homepageApiDoc').css('color', 'white');
                    $('#homepageLogin').css('color', 'white');
                    $('#homepageSignup').css('color', 'white');
					$('#languageSpan').css('color', 'white');
					

                    $('#navBarHamburger').addClass('changeWhitePage');
