						...
						<div class="col-12">
							<div class="row pb-4">
								...
								<div class="col-md-6 pr-0">
									<img src="images/whitelabel/ppay/homepage01.png" alt="" width="100%">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-12">
							<div class="row align-items-center">
								<div class="col-md-5 pl-0 position-relative">
									<img src="images/whitelabel/ppay/homepage02.png" alt="" width="90%">
									...
									<div>
										...
										<div class="d-flex align-items-center mb-4">
											...
											<div class="col normalText">
												<b class="d-inline-flex align-items-center">World Wide <img class="ml-3" src="images/whitelabel/ppay/ico_world.png" width="30px"></b>
										...
										<div class="d-flex align-items-center mb-4">
											...
											<div class="col normalText">
												<b class="d-inline-flex align-items-center">Easy Implemetation <img class="ml-3" src="images/whitelabel/ppay/ico_implement.png" width="30px"></b>
												<span class="d-block mt-1 text-grey">
										...
										<div class="d-flex align-items-center mb-4">
											...
											<div class="col normalText">
												<b class="d-inline-flex align-items-center">Access Anytime, Anywhere <img class="ml-3" src="images/whitelabel/ppay/ico_anytime.png" width="30px"></b>
												<span class="d-block mt-1 text-grey">
													Mobile Accessible & get instant notification with PPay no matter where you go and what time it is
												</span>
											</div>
										</div>
										...
										<div class="d-flex align-items-center mb-4">
											...
											<div class="col normalText">
												<b class="d-inline-flex align-items-center">FinTech Expert <img class="ml-3" src="images/whitelabel/ppay/ico_fintech.png" width="30px"></b>
												<span class="d-block mt-1 text-grey">
										...
										<div class="d-flex align-items-center mb-4">
											...
											<div class="col normalText">
												<b class="d-inline-flex align-items-center">Accept All Business Type <img class="ml-3" src="images/whitelabel/ppay/ico_business.png" width="30px"></b>
												<span class="d-block mt-1 text-grey">
										...
										<div class="d-flex align-items-center mb-4">
											...
											<div class="col normalText">
												<b class="d-inline-flex align-items-center">One Reconciliation <img class="ml-3" src="images/whitelabel/ppay/ico_statistic.png" width="30px"></b>
												<span class="d-block mt-1 text-grey">
						...
						<div class="col-12">
							<div class="row justify-content-center">
								<div class="homepageAbtBlock normalText">
									<img src="images/whitelabel/ppay/ico_total.png" width="40px">
									<div>Total</div>
									<div class="bigTxt">20,000,000+</div>
									<div class="mt-2">Transactions</div>
								</div>
								<div class="homepageAbtBlock normalText">
									<img src="images/whitelabel/ppay/ico_process.png" width="40px">
									<div>We’ve processed over</div>
									<div class="bigTxt">$ 50 million</div>
									<div class="mt-2">Yearly</div>
								</div>
								<div class="homepageAbtBlock normalText">
									<img src="images/whitelabel/ppay/ico_available.png" width="40px">
						...
						<div class="col-12">
							<div class="row align-items-center">
								...
								<div class="col-md-5 offset-md-1">
									<img src="images/whitelabel/ppay/homepage03.jpg" alt="" width="100%">
								</div>
							</div>
						</div>
					</div>
						...
						<div class="col-12">
							<div class="row align-items-center">
								<div class="col-md-7 pl-0 position-relative">
									<img src="images/whitelabel/ppay/homepage04.png" alt="" width="100%">
								</div>
								<div class="col-md-5">
									<div>
