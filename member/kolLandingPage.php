					...
					<div class="col-xl-7 col-lg-12 col-12 landingPageContainerMargin blueContainerMobile">
						<div class="row landingPageContainer">
							<div class="col-6 px-0">
								<img src="<?php echo $sys['domain'] ?>/images/LandingElements/kol-pic.png" class="kolImage">

							</div>

							<div class="col-6 landingPageDetails">
								<span class="kolName">Dr. Jason Leong</span>
								<div class="kolDescription">
									<div class="memberLandingPageSection1Title kolReview">"NuxPay was surprising easy to use and the transaction was smooth. Great platform."</div>
							...
							<div class="row justify-content-center">
								<div class="signUpFormBox">
									...
									<div class="col-12">
										...
										<div class="col-12 form-group" style="display: flex;"s id="mobileDiv">
