						...
						<div class="p-b-0">
							<form>
								<div id="basicwizard" class="pull-in">
									<div class="tab-content b-0 m-b-0 p-t-0">
										<div id="alertMsg" class="alert" style="display: none;"></div>
										<div id="resellerFundOutDetailsDiv" class="table-responsive"></div>
										<span id="paginateText"></span>
										<div class="text-center" style="">
											<ul class="pagination pagination-md" id="pagerResellerFundOutDetails">
											</ul>
										</div>
									</div>
								</div>
...
<script>
	var divId = 'resellerFundOutDetailsDiv';
	var tableId = 'resellerFundOutDetailsTable';
	var pagerId = 'pagerResellerFundOutDetails';
	var btnArray = {};
	var thArray = Array(
		'Date',
		'Recipient Type',
	...
	$(document).ready(function() {
		...
		var formData = {
			command: "resellerFundOutDetails",
			page: pageNumber,
