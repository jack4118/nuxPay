...
<div id="wrapper">
                                                        ...
                                                        <div class="col-sm-12 form-group">
                                                            ...
                                                            <form>
                                                                <select id="country" autocomplete="off" class="form-control">
                                                                    <?php include 'newCountryList.php'; ?>
                                                                </select>
                                                            </form>
                                                        </div>
    ...
    <script>
        ...
        var formData = "";
        var fCallback = "";
        var countryStrCode = '<?php echo $_SERVER["HTTP_CF_IPCOUNTRY"] ?>';
        ...
        $(document).ready(function() {
            ...
            // set default country according to countryCode
            if (countryStrCode != ""){
                $('#country').find('option').each(function(){
                    if (countryStrCode && countryStrCode != "ZZ") {
                        if ($(this).attr("data-countrycode") == countryStrCode) {
        ...
        $('#addUserBtn').click(function() {
            ...
            var site = '<?php echo $config["companyName"];?>';

            formData = {
                command: 'adminResellerCreateDistributor',
                username: username,
                nickname: nickname,
                email: email,
                password: password,
        ...
        function loadCreateUser(data, message) {
            showMessage(message, 'success', 'Added new agent', '', 'distributorListing.php');
        };
