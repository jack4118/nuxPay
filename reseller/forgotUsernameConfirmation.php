...
<div class="modal fade" id="canvasMessage" role="dialog">
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#forgotUsernameConfirmation').click(function(){
                ...
                if (userOtp == ''){
                    ...
                    formData = {
                        command: 'resellerRequestUsername',
                        email: email,
                        user_otp: userOtp,
                        source: siteSource
                    };

                    var fCallback = usernameCallback;
        ...
        function usernameCallback(data, message, objData){
            if (objData.status == "ok"){
                message = 'Your account’s username has been sent to your email';
                showMessage(message, 'success', 'Username Sent', "check-circle-o", "pageLogin.php");
            }
        }
