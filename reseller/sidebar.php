...
//        }
        ...
        $array[$item['id']]['isTesting'] = $item['isTesting'];
            ...
            <ul>
                ...
                <?php 
                    ...
                    foreach($sideBarAry as $sideBar){
                        if($sideBar["isTesting"] == 1 && $sideBar["type"] == "Menu" && $sideBar["filePath"] != ""){
                            echo '<li style="display:none;">';
                            echo '<a href="'.$sideBar["filePath"].'" class="waves-effect"><i class="fa '.$sideBar["icon"].' fa-fw"></i> <span>'.$sideBar["name"].'</span> </a>';
                            echo '</li>';
                        }else if($sideBar["type"] == "Menu" && $sideBar["filePath"] != ""){
                            if ( in_array($_SESSION['userID'], $config['specialAccess'], true ) ) {
                                echo '<li>';
                                echo '<a href="'.$sideBar["filePath"].'" class="waves-effect"><i class="fa '.$sideBar["icon"].' fa-fw"></i> <span>'.$sideBar["name"].'</span> </a>';
                                echo '</li>';
                            }else{
                                if ($sideBar["filePath"] != "kycListing.php") {
                                    echo '<li>';
                                    echo '<a href="'.$sideBar["filePath"].'" class="waves-effect"><i class="fa '.$sideBar["icon"].' fa-fw"></i> <span>'.$sideBar["name"].'</span> </a>';
                                    echo '</li>';
                                }
                        ...
                        if($sideBar["isTesting"] == 1 && $sideBar["type"] == "Menu" && $sideBar["filePath"] == ""){
                            echo '<li class="has_sub" style="display:none;">';
                                echo '<a href="javascript:void(0);" class="waves-effect"><i class="fa '.$sideBar["icon"].' fa-fw"></i> <span>'.$sideBar["name"].'</span> <span class="menu-arrow"></span></a>';
                ...
                <!-- <li class="has_sub">
                    ...
                    <ul class="list-unstyled" style="">
                        <li class="">
                            <a href="allTicket.php" class="">All Ticket</a>
                        </li>
                        <li>
                            <a href="createnewTicket.php">Create New Ticket</a>
                        </li>
                        <li>
                            <a href="allUnassignedTicket.php">All Unassigned Ticket</a>
                        </li>
                        <li>
                            <a href="allCloseTicket.php">All Close Ticket</a>
                        </li>
                        <li>
                            <a href="myOpenPendingTicket.php">My Open & Pending Ticket</a>
                        </li>
                        <li>
                            <a href="myCloseTicket.php">My Close Ticket</a>
                        </li>
                    </ul>
                </li> -->

                <!-- <li>
                    <a href="reseller.php" class="waves-effect">
