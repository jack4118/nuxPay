        ...
        $("#forgotPasswordConfirmation").click(function(){
            ...
            if(email!=""){
                ...
                $.ajax({
					...
					url     : 'scripts/reqChangePassword.php', // the url where we want to POST
				...
				.done(function(data) {
					...
					// console.log(obj);
					if(obj.status == "ok") {
						$.redirect('forgotPasswordConfirmation.php', {
						...
						$('#loginError').html('<span>' + obj.statusMsg + '</span>').css('display', 'block');
					}
				});
