...
<div id="wrapper">
    ...
    function loadDefaultListing(data, message) {
        ...
        if(data.ticketList) {
            ...
            $('#'+tableId+' tbody tr').click(function() {
                ...
                $.redirect("ticketInfo.php", {id: id, previousPage: "myCloseTicket.php"});
            });
    ...
    function updateColumn(data, message) {
        showMessage('Successfully updated.', 'success', 'Update Ticket', 'edit', 'myCloseTicket.php');
    }

    function deleteTicket(data, message) {
        showMessage('Successfully deleted.', 'success', 'Delete Ticket', 'trash', 'myCloseTicket.php');
    }
</script>
