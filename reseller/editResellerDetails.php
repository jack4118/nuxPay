...
-->
                                                ...
                                                <div class="col-sm-6 px-0">
                                                    ...
                                                    <div id="blogDIV">
                                                        ...
                                                        <div class="col-sm-12 form-group">
                                                            ...
                                                            <select class="form-control select2 select2-multiple" id="status">
    ...
    <script>
        ...
        function loadAdminDetails(data, message) {
            ...
            var disabled = adminDetails.disabled;
            var login_userID =  "<?php echo $_SESSION['userRoleID']; ?>";
            dist_name = distributor_username;
            ...
            if (login_userID == 8){
                ...
                $("<option/>", {
                    value: distributor_username,
                    html: distributor_username
                }).appendTo($("#dropdownDistributor"));

                $("#dropdownDistributor").attr('disabled', 'disabled');
            }
        ...
        $('#editAdminBtn').click(function() {
            ...
            formData = {
                ...
                nickname: nickname,                
                email: email,
                distributor_username: dist_name,
                disabled: disabled
            };
