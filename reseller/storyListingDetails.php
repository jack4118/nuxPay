                                    ...
                                    <div class="row">
                                        ...
                                        <div id="" class="col-sm-12">
                                            <div class="col-sm-6 form-group">
                                                <div class="mb-3">
                                                    <span>Organizer :</span>
                                                    <input id="inputOrganizer" type="text" class="form-control" value="">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <div class="mb-3">
                                                    <span>Country :</span>
                                                    <input id="inputCountry" type="text" class="form-control" value="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div id="" class="col-sm-12">
                                            <div class="col-sm-6 form-group">
                                                <div class="mb-3">
                                                    ...
                                                    <input id="inputPaymentMethod" type="text" class="form-control" value="">
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="" class="col-sm-12">
                                            ...
                                            <div class="col-sm-6 form-group">
                                                <div class="mb-3">
                                                    <span>Category :</span>
                                                    <input id="inputCategory" type="text" class="form-control" value="">
                                                </div>
                                            </div>
                                            <div class="col-sm-6 form-group">
                                                <div class="mb-3">
                                                    <span>Target Amount (USD) :</span>
                                                    <input id="inputFundAmount" type="text" class="form-control" value="">
                                                </div>
                                            </div>

                                            <div class="col-sm-6 form-group">
                                                <div class="mb-3">
                                                    <span>Amount Raised (USD) :</span>
                                                    <input id="inputFundRaise" type="text" class="form-control" value="">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-sm-6 form-group">
                                                <div class="mb-3">
                                                    <span>Duration :</span>
                                                    <input id="inputFundPeriod" type="text" class="form-control" value="">
                                                </div>
                                            </div>
...
<script>
    ...
    function redirectBreadcrumb(link,data){
      if (data) {
        $.redirect(link, {dataID: businessID});
      }else{
        $.redirect(link, {dataID: businessID});
      }
    }
    ...
    function loadDefaultListing(data, message) {
        ...
        $('#inputOrganizer').val(data.nickname);
        $('#inputTitle').val(data.title);
        $('#inputDescription').val(data.description);
        $('#inputCategory').val(data.category_type);
        $('#inputFundAmount').val(data.fund_amount);
        $('#inputFundRaise').val(data.fund_collected);
