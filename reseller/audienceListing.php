                                    ...
                                    <div id="" class="table-responsive">
                                        <table class="table table-striped table-bordered no-footer m-0">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Team A</td>
                                                    <td>This is Team A description</td>
                                                    <td>4</td>
                                                    <td><a href="viewAudience.php" title="" class="m-t-5 m-r-10 btn btn-icon waves-effect waves-light btn-primary" data-original-title="Edit"><i class="fa fa-eye"></i></a><a href="editAudience.php" title="" class="m-t-5 m-r-10 btn btn-icon waves-effect waves-light btn-primary" data-original-title="Edit"><i class="fa fa-edit"></i></a></td>
                                                </tr>
                                                <tr>
                                                    <td>Team B</td>
                                                    <td>This is Team B description</td>
                                                    <td>4</td>
                                                    <td><a href="viewAudience.php" title="" class="m-t-5 m-r-10 btn btn-icon waves-effect waves-light btn-primary" data-original-title="Edit"><i class="fa fa-eye"></i></a><a href="editAudience.php" title="" class="m-t-5 m-r-10 btn btn-icon waves-effect waves-light btn-primary" data-original-title="Edit"><i class="fa fa-edit"></i></a></td>
                                                </tr>
                                                <tr>
                                                    <td>Team C</td>
                                                    <td>This is Team C description</td>
                                                    <td>4</td>
                                                    <td><a href="viewAudience.php" title="" class="m-t-5 m-r-10 btn btn-icon waves-effect waves-light btn-primary" data-original-title="Edit"><i class="fa fa-eye"></i></a><a href="editAudience.php" title="" class="m-t-5 m-r-10 btn btn-icon waves-effect waves-light btn-primary" data-original-title="Edit"><i class="fa fa-edit"></i></a></td>
                                                </tr>
                                            </tbody>
...
<div class="modal fade in viewAudienceDetails" id="canvasMessage" role="dialog" style="padding-right: 16px;">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <h4 class="modal-title">
          ...
          <span style="">View Audience Details</span>
      </h4>
  </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        // $('.viewAudienceDetails').modal('show');
