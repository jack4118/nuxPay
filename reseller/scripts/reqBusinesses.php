    ...
    if($_POST['type'] == 'logout'){
        ...
        switch($command) {
            ...
            $params = array(
                ...
                "create_date_from"     => strtotime($_POST['fromCreateDate']),
                "create_date_to"       => strtotime($_POST['toCreateDate']),

                "login_date_from"      => strtotime($_POST['fromLoginDate']),
                "login_date_to"        => strtotime($_POST['toLoginDate']),

                "business_id"          => $_POST['business_id'],
                "business_name"        => $_POST['business_name'],
                "email"                => $_POST["email"],
                "phone_number"         => $_POST["phone_number"],
                "reseller"             => $_POST['reseller_username'],
                "distributor"          => $_POST['distributor_username'],
