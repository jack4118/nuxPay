<?php
	...
	class post{
		...
		public function curl($command, $params = array(), $site="Reseller", $language="english", $source="Web", $sourceVersion="", $userAgent="")
        {
...
//		    curl_setopt($ch, CURLOPT_TIMEOUT, 60); //timeout in seconds
            ...
            if ($command != 'resellerLogin')
                $msgReturn = json_encode($msgReturn);
            
		    return $msgReturn;
		}

        public function curlUtm($command, $params = array(), $site="Admin", $language="english", $source="Web", $sourceVersion="", $userAgent="")
        {
            include(__DIR__.'/config.php');
            include(__DIR__.'/class.msgpack.php');
            ...
            // return $dataArray;
            $webServiceUrl = $config['utmWebserviceURL'];
