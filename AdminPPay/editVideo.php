       ...
       <div class="row">
        ...
        <div class="col-lg-12 col-md-12">
          ...
          <div class="col-sm-12 my-4 px-0">
            <button id="editVideoBtn" type="submit" class="btn btn-primary waves-effect waves-light">Edit</button>
          </div>
        </div>
      </div>
      <!-- End row -->
...
<script>
  ...
  function loadAddBlog(data,message){
      // console.log(data);
      showMessage(message, 'success', 'Edit Video','' , 'blogVideo.php');
  };
</script>
