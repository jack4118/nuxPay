                ...
                <div class="col-lg-12 col-md-12">
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                        ...
                        <div class="col-sm-12 my-4 px-0">
                            <button id="addAnnouncementBtn" type="submit" class="btn btn-primary waves-effect waves-light">Add</button>
                        </div>
                    </div>
                </div>
                <!-- End row -->
...
function callAdd(get_url,put_url) {
    ...
    var formData  = {
        command: 'adminAnnouncementCreate',
    ...
    var fCallback = loadAddBlog;
        ...
        function loadAddBlog(data,message){
            // console.log(data);
            showMessage(message, 'success', 'Added Annoucement','' , 'scheduleAnnouncement.php');
        };
