                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form id="searchForm" role="form">
                                            <div class="col-md-4 form-group">
                                                ...
                                                <input id="referralCode" type="text" class="form-control" dataName="name" dataType="text">
                                            </div>
                                            <div class="col-md-4 form-group">
                                                <label class="control-label">
                                                    Business ID
                            ...
                            <form>
                                <div id="basicwizard" class="pull-in">
                                    <div class="tab-content b-0 m-b-0 p-t-0">
                                        ...
                                        <div id="referralListDiv" class="table-responsive"></div>
                                        <span id="paginateText"></span>
                                        <div class="text-center" style="">
                                            <ul class="pagination pagination-md" id="pagerReferralList">
                                            </ul>
                                        </div>
                                    </div>
                                </div>
...
<script>
    var divId    = 'referralListDiv';
    var tableId  = 'referralListTable';
    var pagerId  = 'pagerReferralList';
    var btnArray = {};
    var thArray  = Array('Referral Code',
       'Business ID',
       'Business Name',
       'Email',
       'Mobile Number',
    ...
    var url             = 'scripts/reqReferral.php';
    var method          = 'POST';
    var debug           = 0;
    ...
    function loadDefaultListing(data, message) {
        ...
        if (freezeList) {
            ...
            $.each(freezeList, function(k,v){
             ...
             var rebuildData ={
                referralID : v['referral_code'],
                businessID : v['business_id'],
                businessName : v['business_name'],
                email : v['business_email'],
                mobileNo : v['business_phone_number'],
