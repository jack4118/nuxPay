...
<div id="wrapper">
                                ...
                                <div id="basicwizard" class="pull-in">
                                    <div class="tab-content b-0 m-b-0 p-t-0">
                                        ...
                                        <div class="" style="margin-top: 10px">
                                            <span id="paginateText"><!-- Showing 1 - 5 of 37 records. --></span>
                                        </div>
    ...
    $(document).ready(function() {
        var formData  = {command : "unassignTickets", pageNumber : pageNumber};
    ...
    function loadDefaultListing(data, message) {
        ...
        if(data.ticketList) {
            ...
            $('#'+tableId+' tbody tr').click(function() {
                ...
                $.redirect("ticketInfo.php", {id: id, previousPage: "allUnassignedTicket.php"});
            });
    ...
    function updateColumn(data, message) {
        showMessage('Successfully updated.', 'success', 'Update Ticket', 'edit', 'allUnassignedTicket.php');
    }

    function deleteTicket(data, message) {
        showMessage('Successfully deleted.', 'success', 'Delete Ticket', 'trash', 'allUnassignedTicket.php');
    }
</script>
