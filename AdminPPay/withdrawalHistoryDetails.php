...
<div id="wrapper">
	...
	<div class="content-page">
		...
		<div class="content">
			...
			<div class="row">
                    <div class="col-xs-12">
                        <a href="javascript:;" onclick="backToHistory()" class="btn btn-primary btn-md waves-effect waves-light m-b-20">
                            <i class="md md-add"></i>
                            Back
                        </a>
                    </div>
						...
						<div class="p-b-0">
							<form>
								<div id="basicwizard" class="pull-in">
									<div class="tab-content b-0 m-b-0 p-t-0">
										<div id="alertMsg" class="alert" style="display: none;"></div>
										<div id="resellerWithdrawalHistoryDetailsDiv" class="table-responsive"></div>
										<span id="paginateText"></span>
										<div class="text-center" style="">
											<ul class="pagination pagination-md" id="pagerResellerWithdrawalHistoryDetails">
											</ul>
										</div>
									</div>
								</div>
...
<script>
	var divId = 'resellerWithdrawalHistoryDetailsDiv';
	var tableId = 'resellerWithdrawalHistoryDetailsTable';
	var pagerId = 'pagerResellerWithdrawalHistoryDetails';
	var btnArray = {};
	var thArray = Array(
		'Date',
		'Recipient Type',
	...
	$(document).ready(function() {
		...
		var formData = {
			command: "resellerWithdrawalHistoryDetails",
			// page: pageNumber,
	...
	function backToHistory() {
        $.redirect("withdrawalHistory.php",{
	...
	function loadDefaultListing(data, message) {
		...
		if (data) {
			var withdrawalHistoryDetails = data.withdrawal_arr;
			if(withdrawalHistoryDetails){
				var newList = [];
			...
			if(withdrawalHistoryDetails){
				...
				$.each(data, function(k, v) {
					var rebuildData = {
						...
						processing_fee_amount: v['processing_fee_amount']
					};
