    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#changePassword').click(function() {
                $.redirect('changePassword.php', {id : "<?php echo $_POST['id']; ?>"});
            });
		 	$('#withdrawalAddressListing').click(function() {
                $.redirect('withdrawalAddressListing.php', {id : "<?php echo $_POST['id']; ?>"});
            });
            $('#apiCallbackURL').click(function() {
                $.redirect('apiCallbackListing.php', {id : "<?php echo $_POST['id']; ?>"});
            });
            $('#apiKeyListing').click(function() {
                $.redirect('apiKeyListing.php', {id : "<?php echo $_POST['id']; ?>"});
            });
