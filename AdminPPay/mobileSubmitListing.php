...
<?php include("head.php"); ?>
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form id="searchForm" role="form">
                                                ...
                                                <div class="col-sm-4 form-group">
                                                    ...
                                                    <input id="urlNo" type="text" class="form-control" dataName="urlName" dataType="text">
                                                </div>
                                                <div class="col-sm-4 form-group">
                                                    <label class="control-label">
                                                        Country
    ...
    var btnArray = {};
    var thArray  = Array('Mobile Number',
                         'Date',
                         'IP',
                         'Country',
                         'URL',
    ...
    var formData        = "";
    var fCallback       = "";
    var mobileNo, country, domain, urlSearch, date_from, date_to;;

    $(document).ready(function() {

        var fCallback = loadDefaultListing;
        formData  = {
            command: 'adminMobileSubmitList'
        };
    ...
    function loadDefaultListing(data, message) {
        var mobileList = data.listing;
        var tableNo;

        if(mobileList){
            var newList = [];
            $.each(mobileList, function(k,v){
                if (!v['mobile_number']){
                   v['mobile_number'] ="-"; 
                }
                if (!v['ip']){
