...
if($_SERVER['REQUEST_METHOD'] == 'POST')
{
    ...
    switch($command) {
     ...
     // print_r($params);
            // exit();
            $result = $post->curl_post("/web/pay/login", $params,"Member","english","GemDirectPay");
            // print_r($result);
            // exit();
        ...
        case "resendEmail":
                ...
                $result = $post->curl_post("/xun/web/pay/register/resend-email", $params,"Member","english","GemDirectPay");
        ...
        case "registerXun":
                ...
                $result = $post->curl_post("/xun/business/mobile/verifycode/register", $params,"Member","english","GemDirectPay");
        ...
        case "verifyCode":
                ...
                $result = $post->curl_post("/web/pay/register/otp/verify", $params,"Member","english","GemDirectPay");
