				...
				<section class="pPayTrackerBG">
					<div class="kt-container">
						<div class="row justify-content-center">
							...
							<div class="col-12 pPayTrackerTitle text-center">
								Transaction Tracker
							</div>

							<div class="col-lg-12 col-md-8 col-12 text-center pPayTrackerDesc">
							...
							<div class="col-12" style="margin-top: 40px;">
								<div class="row justify-content-center">
									<div class="col-md-6 col-12">
										<label class="pPayTrackerLabel">Enter your transaction ID  :</label>
										<input type="text" class="form-control pPayTrackerForm" autocomplete="off">
									</div>
								</div>
							</div>

							<div class="col-12 text-center" style="margin-top: 20px;">
								<button type="button" class="btn pPayTrackResetBtn">Reset</button>
								<button id="trackClick" type="button" class="btn pPayTrackBtn">Track</button>
							</div>
