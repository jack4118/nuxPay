				...
				<div class="d-flex align-items-center">
                    <div class="col-12">
                        <div class="d-flex border-bottom justify-content-between">
                            <nav class="nav">
                            <a class="nav-link active" id="successBtn" href="javascript:void(0)">Whitelisting</a>
                    ...
                    <div class="row">
                        <div class="col-12 mt-3">
                            <div class="row">
                                ...
                                <div class="col-12 small font-weight-light" style="color: gray;">
                                    Security is critical at NuxPay. To improve cybersecurity, build an address whitelist by adding approved wallet addresses to your fund out list.
                                </div>
                                        ...
                                        <div class="m-portlet__body">
                                            <div class="row m-form">
                                                        ...
                                                        <div class ="col-12" style="margin-left: -1px; margin-bottom: -12px;">
                                                            <div class = "row" >
                                                                <div class="form-group mt-2 col-12" style="display:flex; flex-direction: row;">
                                                                    <label style="color:gray; width: 30px; align-items: center; margin-top:8px; margin-right: 10px;" for="textField" class="font-weight-light"><?php echo $i; ?>. </label>
                                                                    <input placeholder="Key in wallet address" style=""class ="whitelistAddressText" name="textField_<?php echo $i;?>" id="textField_<?php echo $i;?>" type="text"/>
                                                                    <select class="whitelistWalletType" name="walletType_<?php echo $i;?>" id="walletType_<?php echo $i;?>">
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                ...
                                                <div class ="col-6 col-md-6">
                                                    ...
                                                    Uploading whitelist addresses in bulk. 
                                                    </div>
                                                    <div class="col-12 mt-3 small font-weight-light" style="color: gray;"> 
                                                    You can upload whitelist addresses in bulk if you have all of your addresses in a single file.
                                                    </div>
                                                    <div class="col-12 mt-3 small font-weight-light" style="color: gray;"> 
                                                    The file must be in excel workbook (xlsx) format, and the header of the file must be this string exactly: "No, Address".
                                                    </div>

                                                    <div class="col-12">
                                                        <div class="row col-12">
                                                            <a class="col-4.5 small font-weight-light" href="batchWhitelistAddress.xlsx">Download sample file </a>
                                                            <div class="col-7.5 small font-weight-light" style="color: gray;">&nbsp;for reference.</div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12 mt-5">
                                                        <div class="row col-12">
                                                            <div class="font-weight-normal" style="width: 130px; margin-top: 5px; ">Type of address:</div>
                                                    ...
                                                    <div class="col-12 mt-3">
                                                        <div class="row col-12">
                                                            <button id="uploadBtn" class="col-1 btn searchBtn my-2" type="button" onClick="onUpload();">Upload</button>
                        ...
                        <div class="col-12">
                            <button id="submitBtn" class="btn whitelistBtn my-2" type="button" onClick="onSubmit()";>Submit</button>
                        </div>
                    </div>
        ...
        <div class="modal-content">
            <div class="modal-header bg-w border-b justify-content-center">
                <div class="modal-title hasSub">
                    ...
                    <p class="my-0 enableStep1">An SMS with OTP code has been sent to your mobile number<br> <?php echo $_SESSION['mobile']?></p>
...
<!--                        <img id="authenticatorQR" src="images/qrcode.jpg" width="150px" class="my-3">-->
                        ...
                        <ul class="text-left pl-3">
                            ...
                            <li>Scan QR code with the authenticator.</li>
                            <li>Enter 6-digits codes from authenticator.</li>
                        </ul>
                    </div>
            ...
            <div class="modal-body border-b" style="line-height: 25px;">
                <div class="col-12 text-center">
                    <p class="enableStep1">Enter your OTP code</p>
                    <p class="enableStep2" style="display: none;">Enter your 2-factor authenticator code</p>
                    ...
                    <p id ="didNotReceiveSms" >Didn't receive the SMS? <a href="javascript:;" onclick="requestOTP()">Re-send SMS</a></p>
        ...
        if(data.result.coin_data && dropdownFake !=1) {
            ...
            for(var i=1; i<=<?php echo $sys['maxWhitelistAddressRow']; ?>; i++) {
                ...
                $.each(data.result.coin_data, function(key, val) {
                    $('#walletType_'+i).append('<option data-image="'+val['image']+'" value="'+ val['wallet_type'] +'">'+ val['symbol'] +'</option>')
                });
            }
