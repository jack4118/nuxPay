                                    ...
                                    <div class="m-portlet m-portlet--tab">
                                        ...
                                        <form class="m-form m-form--fit m-form--label-align-right">
                                            <div class="m-portlet__body">
                                                    ...
                                                    <div class="form-group m-form__group">
                                                        <a id="saveSettings" href="#" class="btn btn btn m-btn--pill m-btn--air btn-outline-metal btn-sm m-btn m-btn--custom newSaveBtnDesign" style="color:white;border-color:#0077b2; background-color: #0077b2"  role="button"> <?php echo $translations["M01270"][$language]; /* Save */ ?></a>
                                                    </div>
                                            </div>
                                        </form>
                                    </div>
