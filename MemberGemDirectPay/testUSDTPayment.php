<?php
	...
	$business_id = "10013";//"10010";
	$api_key = "rkAq14Ifh3QJLaZeYMbVlgTWXtPRNmxy";//"dHlkyo9iuDngLscw2ZUJpFP3V6qAmEX5";
	$fundInCurrency = "tetherUSD";
	$fundInAmount = "";
	$ref = "test";
	$returnURL = "https://devmember2.gemdirectpay.com/testreturn.php";
	...
	$ws_url = "http://dev.nuxpaywhitelabelbackend.testback/payment_gateway/merchant/transaction/request";
	    ...
	    echo '<form action="https://devmember2.gemdirectpay.com/qrPayment.php" method="post" id="frm" >';
