                            ...
                            <div class="panel-body">
                                ...
                                <form id="searchForm" role="form">
                                    <div class="col-sm-4 form-group">
                                        ...
                                        <input id="name" type="text" class="form-control" dataName="ID" dataType="text">
                                    </div>
                                    <div class="col-sm-4 form-group">
                                        <label class="control-label">
                                            Country
                                        </label>
                                        <input id="country" type="text" class="form-control" dataName="businessName" dataType="text">
                                    </div>
                                </form>
                                ...
                                <table class="table table-striped table-bordered no-footer m-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>Malaysia</td>
                                            <td>100 TNC</td>
                                            <td>Registered more than 6 months</td>
                                        </tr>
                                        <tr>
                                            <td>Member B</td>
                                            <td>Malaysia</td>
