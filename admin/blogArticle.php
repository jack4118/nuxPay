        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                   ...
                   <!-- Table -->
                   <a id="addArticle" href="newArticle.php" type="button" class="btn btn-primary waves-effect w-md waves-light m-b-20">
                            New article
                        </a>
                    <div class="row">
                        <div class="col-md-12">
...
<script>
    ...
    $(document).ready(function() {
        ...
        formData  = {
            command: 'adminGetArticleListing'
        };
    ...
    function tableBtnClick(btnId) {
        ...
        if (btnName == 'edit') {
            ...
            $.redirect("editArticle.php",{blogID: blogID});
