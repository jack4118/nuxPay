                                    ...
                                    <div id="basicwizard" class="pull-in">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>4</td>
                                                <td><a href="editBlastMessage.php" data-toggle="tooltip" title="" class="m-t-5 m-r-10 btn btn-icon waves-effect waves-light btn-primary" data-original-title="Edit"><i class="fa fa-edit"></i></a><a data-toggle="modal" data-target=".viewHistoryModal" title="" class="m-t-5 m-r-10 btn btn-icon waves-effect waves-light btn-primary" data-original-title="Edit"><i class="fa fa-eye"></i></a><a data-toggle="modal" data-target="" title="" class="m-t-5 m-r-10 btn btn-icon waves-effect waves-light btn-primary" data-original-title="Edit"><i class="fa fa-trash"></i></a></td>
                                            </tr>
                                            <tr>
                                                <td>28/8/2019 12:00PM</td>
         ...
         <div id="searchForm" role="form" class="text-left col-sm-12" style="padding: 10px; padding-bottom: 30px">
            <div class="col-sm-12 form-group">
                ...
                <div class="col-sm-7 text-left">
                    <p class="form-control-static" style="padding-top: 0">28/8/2019 12:00PM</p>
                </div>
            </div>
            <div class="col-sm-12 form-group">
                <label class="col-sm-5 control-label">Title</label>
                <div class="col-sm-7 text-left">
                    <p class="form-control-static" style="padding-top: 0">Happy Merdeka</p>
                </div>
            </div>
            <div class="col-sm-12 form-group">
