                                        ...
                                        <form id="searchForm" role="form">
                                            ...
                                            <div class="col-md-4 form-group" style="height: 62px;">
                                                ...
                                                <div class="input-group input-daterange" id="m_datepicker_5">
                                                    <input id="fromDate" type="text" class="form-control input-daterange-from" placeholder="From" dataName="transationDate" dataType="dateRange" autocomplete="off" name="start" value="<?php echo $_POST['searchfromDate']; ?>" />
                                                    <span class="input-group-addon">
                                                        To
                                                    </span>
                                                    <input id="toDate" type="text" class="form-control input-daterange-to" placeholder="To" dataName="transactionDate" dataType="dateRange" autocomplete="off" name="end" value="<?php echo $_POST['searchtoDate']; ?>" />
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-4 form-group">
                                                ...
                                                <input id="hashCode" type="text" class="form-control" dataType="text" value="<?php echo $_POST['searchhashCode']; ?>">
                                            </div>
                                            <!-- <div class="col-sm-4 form-group">
                                                <label class="control-label" data-th="disabled">
                                                    Status
                                                ...
                                                <select id="status" class="form-control" dataName="disabled" dataType="select">
                                                    ...
                                                    <option value="pending" <?php echo $_POST['searchstatus'] == 'pending'?'selected': ''; ?>>Pending</option>
                                                    <option value="success" <?php echo $_POST['searchstatus'] == 'success'?'selected': ''; ?>>Success</option>
                                                    <option value="received" <?php echo $_POST['searchstatus'] == 'received'?'selected': ''; ?>>Received</option>
                                                    <option value="failed" <?php echo $_POST['searchstatus'] == 'failed'?'selected': ''; ?>>Failed</option>
                                                </select>
                                            </div> -->
                                            <div class="col-md-4 form-group">
                                                <label class="control-label" for="" data-th="email">
...
<script>
        ...
        if (freezeList) {
                ...
                $.each(freezeList, function(k, v) {
                    ...
                    var rebuildData = {
                        ...
                        //senderAdd: senderAddress.slice(0, 4) + '...' + senderAddress.slice(-5,-1),
                        senderAdd: v['sender_address'],
                        // txHash: finalTHash
    ...
    function tableBtnClick(btnId) {
        ...
        var searchhashCode = $("#hashCode").val();
