                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form id="searchForm" role="form">
                                            ...
                                            <div class="col-md-4 form-group">
                                                ...
                                                <input id="site" type="text" class="form-control" dataName="distributor" dataType="text">
                                            </div>
...
<script>
    ...
    $(document).ready(function() {
        ...
        var formData = {
            command:    'adminDistributorListing',
    ...
    function loadDefaultListing(data, message) {
            ...
            var adminDistributorListing = data.admin_distributor_listing;
            var tableNo;

            if (adminDistributorListing) {
                var newList = [];
                $.each(adminDistributorListing, function(k, v) {

                    var rebuildData = {
                        site:            v['distributor_site'],
