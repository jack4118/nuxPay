...
<div id="wrapper">
    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <a id="addBackBtn" href="adminListing.php" class="btn btn-primary btn-md waves-effect waves-light m-b-20"><i class="md md-add"></i>Back</a>
                    </div><!-- end col -->
                </div>
    ...
    <script>
        ...
        function loadCreateAdmin(data,message){
            // console.log(data);
            showMessage(message, 'success', 'Added User','' , 'adminListing.php');
        };
