...
<script>
    ...
    function loadDefaultListing(data, message) {
        ...
        var adminResellerListing = data.admin_reseller_listing;
        var tableNo;

        if (adminResellerListing) {
            var newList = [];
            $.each(adminResellerListing, function(k, v) {
        ...
        if(adminResellerListing){
             $.each(adminResellerListing, function(k, v) {
            $('#' + tableId).find('tr#' + k).attr('data-th', v['reseller_id']);
            });
