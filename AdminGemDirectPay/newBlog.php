                                        ...
                                        <div class="col-sm-12 px-0">
                                            <div class="col-sm-6 px-0">
                                                ...
                                                <div class="col-sm-12 form-group">
                                                    <div id="" class="m-b-20" style="margin-top: 10px">
                                                        <div class="radio radio-info radio-inline">
                                                            <input type="radio" name="radioInline" value="blog" id="" checked="">
                                                            <label for="">
                                                                Blog
                                                            </label>
                                                        </div>
                                                        ...
                                                        <div class="radio radio-info radio-inline">
                                                            <input type="radio" name="radioInline" value="news" id="newsRadio">
                                                            <label for="">
                                                                News
                                                            </label>
                                                        </div>
                                                ...
                                                <div id="blogDIV">
                                                    <div class="col-sm-12 form-group">
                                                        ...
                                                        <input id="url_name" type="text" class="form-control" placeholder="e.g https://www.thenux.com/blog/blog.php#yourURLName" value="">
                                                    </div>
