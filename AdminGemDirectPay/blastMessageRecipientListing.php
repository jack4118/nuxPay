        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                   <div class="row">
                     <div class="col-sm-4">
                        <a id="addBackBtn" href="blastMessageHistory.php" class="btn btn-primary btn-md waves-effect waves-light m-b-20"><i class="md md-add"></i>Back</a>
                     </div><!-- end col -->
                 </div>
                    <div class="row">
                        <div class="col-lg-12">
                                        ...
                                        <div class="panel-body">
                                            ...
                                            <form id="searchForm" role="form">
                                                ...
                                                <div class="col-sm-4 form-group">
                                                    ...
                                                    <input id="device" type="text" class="form-control" dataName="device" dataType="text">
                                                </div>
                                                 <div class="col-sm-4 form-group">
                                                    <label class="control-label">
                                                        App Version
                                                    </label>
                                                    <input id="appVersion" type="text" class="form-control" dataName="appVersion" dataType="text">
                                                </div>
                                                <div class="col-sm-4 form-group">
                                                    <label class="control-label">
                                                        Status
