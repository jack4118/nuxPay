    ...
    <div class="content-page">
        ...
        <div class="content">
            <div class="container">
                ...
                <div class="row">
                    <div class="col-sm-4">
                       <a id="addBackBtn" href="blog.php" class="btn btn-primary btn-md waves-effect waves-light m-b-20"><i class="md md-add"></i>Back</a>
                   </div><!-- end col -->
               </div>
               ...
               <div class="row">
                ...
                <div class="col-lg-12 col-md-12">
                                ...
                                <div class="panel-body">
                                    <form id="customPrice" role="form">
                                        <div class="col-sm-6 px-0">
                                            <?php if ($blogType =="blog") { ?>
                                                <div class="col-sm-12 form-group">
                                                    <label class="control-label" for="" data-th="#">URL Name <span class="text-danger">*</span></label>
                                                    <input id="url_name" type="text" class="form-control" dataName="" dataType="text">
                                                </div>
                                            ...
                                            <?php }else{ ?>
                                                <div class="col-sm-12 form-group">
                                                    <label class="control-label" for="" data-th="#">Redirect URL <span class="text-danger">*</span></label>
                                                    <input id="redirect_url" type="text" class="form-control" dataName="" dataType="text">
                                                </div>
                                            ...
                                            <div class="col-sm-12 form-group">
                                                <label class="control-label" for="" data-th="#">Source</label>
                                                <input id="source" type="text" class="form-control" dataName="" dataType="text">
                                            </div>
                                        </div>
                    ...
                    <div class="col-sm-12 my-4 px-0">
                        <button id="editBtn" type="submit" class="btn btn-primary waves-effect waves-light">Save Changes</button>
                    </div>
                </div>
            </div>
            <!-- End row -->
...
<script>
    ...
    function loadEditBlog(data,message){
        // console.log(data);
        showMessage(message, 'success', 'Update Blog','' , 'blog.php');
    }
