        ...
        <div class="content-page">
            ...
            <div class="content">
                <div class="container">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form id="searchForm" role="form">
                                            ...
                                            <div class="col-sm-4 form-group">
                                                ...
                                                <input type="text" id="title" class="form-control" dataname="" datatype="text">
                                            </div>
                                            ...
                                            <div class="col-sm-4 form-group">
                                                ...
                                                <input type="text" id="tag" class="form-control" dataname="" datatype="text">
                                            </div>
                                        </form>
                                        <!-- hidden -->
                   ...
                   <!-- Table -->
                   <a id="addArticle" href="newVideo.php" type="button" class="btn btn-primary waves-effect w-md waves-light m-b-20">
                            New video
                        </a>
                    <div class="row">
                        <div class="col-md-12">
...
<script>
    ...
    function tableBtnClick(btnId) {
        ...
        if (btnName == 'edit') {
            ...
            $.redirect("editVideo.php",{blogID: blogID,blogType:blogType});
        }else if(btnName == 'delete'){
            var canvasBtnArray = Array('Delete');
            var message = 'Are you sure you want to delete this video?';
